...
2. If the concentration is expressed in mol.m -3 and path length is expressed in meters, then what will be the units of ¦Å? Relate it tothe units when the concentration is expressed in mol.L -1 and path length is expressed in cm.
3. Why are the values of ¦Å max are large for C=C-C=C containing molecules than C=O containing molecules?
...
5. How are the two plots of ¦Åversus wavelength related for two different concentrations of a chromophore?
