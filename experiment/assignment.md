...
2. If the concentration is expressed in mol.m <sup>-3</sup> and path length is expressed in meters, then what will be the units of ¦Å? Relate it tothe units when the concentration is expressed in mol.L <sup>-1</sup> and path length is expressed in cm.
3. Why are the values of ¦Å <sub>max</sub> are large for C=C-C=C containing molecules than C=O containing molecules?
...
4. How will a plot of ¦Å versus wavelength be different from that of absorbance versus wavelength?
5. How are the two plots of ¦Å versus wavelength related for two different concentrations of a chromophore?
